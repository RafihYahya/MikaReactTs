...
const NotificationsCardComp = ({ props }: { props: string }) => {
  return (
    <div id="notifCard" className={`z-100 ${props} absolute  bg-[#EDE8E805] backdrop-blur-md border-b-2 border-t-2  border-pink-600/75 w-[35vw] 2xl:w-[30vw] h-[85vh] 2xl:h-[75vh] rounded-md left-[50%] flex items-center justify-between flex-col py-4 `}>
