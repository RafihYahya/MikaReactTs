    ...
    <div className=" w-[93%] md:w-[90%] lg:w-[75%] lg:h-[33%] 2xl:min-h-[26%] 2xl:h-auto h-[30%] md:h-[24%]
      ...
      <div className=" md:w-[15%] md:h-full w-8 h-8 rounded-md m-2 flex items-center
        ...
        <div className="h-full w-full flex justify-center items-center md:flex-col flex-row gap-32 md:gap-2 pb-6 sm:pb-0">
          <div className="bg-[#ede8e815] backdrop-blur-md rounded-full w-20 h-20  sm:w-14 sm:h-14 
               flex justify-center items-center p-6 md:p-0 hover:text-pink-600/75
               transition-colors duration-300 ease-in-out"><Heart size={28} />
          </div>
          <div className="bg-[#ede8e815] backdrop-blur-md rounded-full w-20 h-20  sm:w-14 sm:h-14
                flex justify-center items-center p-6 md:p-0  hover:text-pink-600/75
                transition-colors duration-300 ease-in-out"><ThumbsUp size={28} /></div>
          <div className="bg-[#ede8e815] backdrop-blur-md rounded-full w-20 h-20  sm:w-14 sm:h-14
                flex justify-center items-center p-6 md:p-0 hover:text-pink-600/75
                transition-colors duration-300 ease-in-out"><ThumbsDown size={28} /></div>
        </div>
      </div>
