      ...
      <div className="w-full  flex items-start justify-center  lg:gap-3  h-full lg:flex-row flex-col">
        ...
        <div className="w-24 h-full  flex items-center justify-center lg:justify-between flex-row lg:flex-col gap-14 lg:gap-1 mx-auto ">
          ...
          <div className="transition-all duration-300 ease-in-out group lg:w-14 hover:w-full lg:h-14 bg-[#EDE8E80e] 
            ...
            <div id='postlistingNums' className=" hidden lg:block  lg:invisible transition-opacity duration-300 ease-in-out opacity-0
                                      group-hover:opacity-100 lg:group-hover:visible">33
              <span className="text-blue-500/50 uppercase font-bold">k</span>
          ...
          <div className="transition-all duration-300 ease-in-out group lg:w-14 hover:w-full lg:h-14 bg-[#EDE8E80e] 
            ...
            <div id='postlistingNums' className="transition-opacity duration-300 ease-in-out hidden lg:block  lg:invisible 
                  opacity-0 group-hover:opacity-100 lg:group-hover:visible">72<span className="text-red-500/50  uppercase font-bold">k</span></div>
          </div>
          <div className="transition-all duration-300 ease-in-out group lg:w-14 hover:w-full lg:h-14 bg-[#EDE8E80e]
                 rounded-full flex justify-center items-center lg:gap-2 lg:mx-6 p-4 lg:p-0">
            ...
            <div id='postlistingNums' className="transition-opacity duration-300 ease-in-out hidden lg:block  
                  lg:invisible opacity-0 group-hover:opacity-100 lg:group-hover:visible">18
              <span className="text-pink-500/50 font-bold uppercase">k</span></div>
          </div>
        </div>
      </div>
