      ...
      <div className=' w-full h-24  md:h-16 lg:h-20  fixed z-50 bg-[#EDE8E807] backdrop-blur-sm '>
        ...
        <div className=' max-w-[1500px] w-full  mx-auto  h-full flex items-center justify-between scale-90 3xl:scale-100 '>
          ...
          <ul className="flex items-center  ">
            ...
            <li title="Chats" id='user' className='px-12 text-md transition-all duration-300 ease-in  hover:scale-110 hover:text-pink-600  md:block hidden '> <NavLink to="/chats" ><Chats size={32} /></NavLink> </li>

          </ul>

          <ul className='flex items-center h-20 md:h-auto'>
            <li title='Login' className=' text-md px-4  hover:font-bold  transition-all duration-300 ease-in hover:scale-110   hover:text-pink-600  md:block hidden  '><NavLink to="/login"><SignIn size={32} />

            </NavLink></li>
            <li title='Register' className=' text-md px-4  hover:font-bold transition-all duration-300 ease-in hover:scale-110  hover:text-pink-600  md:block hidden  '><NavLink to="/register"><Article size={32} />
