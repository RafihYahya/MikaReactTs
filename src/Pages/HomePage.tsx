  ...
  return (
    ...
    <>
      ...
      <div className=' pt-24 fixed overflow-hidden w-full h-full md:grid md:grid-cols-11  p-2  gap-2 lg:pt-24 md:pt-20 '>
        <div id='sideLines' className='py-4 px-2 md:block hidden  md:col-span-1 lg:col-span-2  h-[90.5%] bg-transparent lg:bg-[#ede8e805] backdrop-blur-md rounded-sm text-center '>
        ...
        <div id='mainCenter' className=' flex flex-col md:col-span-9 lg:col-span-7 gap-4  h-full '>
          ...
          <div id="scrollable" className=' h-screen bg-[#EDE8E805] backdrop-blur-md rounded-md text-center overflow-auto  '>
            ...
            <h1 id="spliter" className='text-left ml-[5%] text-2xl font-light uppercase  text-pink-500/75 tracking-widest	  w-[90%]'>P<span className='text-pink-500/75 tracking-wider'>osts</span></h1>
            <PostComp />
            <PostComp />
            <PostComp />
        ...
        <div id='sideLines' className='hidden md:block md:invisible lg:visible md:col-span-1 lg:col-span-2 h-[90.5%] bg-transparent lg:bg-[#ede8e805] backdrop-blur-md rounded-md text-center'>
          <div className='mt-4'>
