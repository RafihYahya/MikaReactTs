  ...
  return (
    ...
    <>
      ...
      <div className='fixed overflow-hidden w-full h-full grid grid-cols-11  p-2  gap-2 lg:pt-24 md:pt-20 '>
        <div id='sideLines' className='  col-span-2 h-[90.5%]  bg-[#EDE8E810] backdrop-blur-md rounded-sm text-center '></div>
        ...
        <div id='sideLines' className='col-span-2 h-[90.5%]  bg-[#EDE8E810] backdrop-blur-md rounded-md text-center'></div>
      </div>
    </>
  )
}
